...
get_feature_importance(model, X_train, y_train)
...
# day of month
# day of year
# number of times travelled from, in given time frame ( more travels means greater demand or demand that has been catered for )
# average tickets booked based on travel from, travel time, etc in train data ( use to project to test )
