...
predictions = rfr_grid.predict(X_val)
...
# 'n_estimators': 600, 'min_samples_split': 10, 'min_samples_leaf': 1, 'max_features': 'auto', 'max_depth': 100, 'bootstrap': True

print(math.sqrt(mean_absolute_error(y_val, predictions)))
